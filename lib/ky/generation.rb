...
module KY
  module Generation
    ...
    def generate_env(input1, input2)
      ...
      raise ConflictingProjectError.new("Config and Secret metadata names do not agree") unless secret_hsh[metadata][name] == config_hsh[metadata][name]
      project = config_hsh[metadata][name]
